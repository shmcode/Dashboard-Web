<x-app-layout>
  ...
  <div class="max-w-5xl mx-auto py-8">
    ...
    <form method="GET" action="{{ route('citizens.grouped') }}" class="mb-6 flex gap-2">
      <input type="text" name="search" value="{{ request('search') }}" placeholder="Buscar por ciudad o ciudadano..."
    ...
    @if($cities->isEmpty())
    <div class="text-center text-gray-500 mb-4">No se encontraron resultados.</div>
    @endif
